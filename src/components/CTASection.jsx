  ...
  return (
    <section className="container-px mx-auto max-w-7xl py-20">
      <motion.div
        ...
        transition={spring}
        className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950 px-8 py-14 shadow-[0_30px_80px_-30px_rgba(37,99,235,0.55)] md:px-14 md:py-20"
      >
