...
export const PROJECTS = [
  {
    ...
    category: 'E-commerce',
    tags: ['Next.js', 'Paystack', 'Stripe'],
    description: 'Online fashion store with MoMo + card checkout and inventory sync.',
  ...
  },
  {
    ...
    description: 'Full school system — students, fees, staff, and result processing.',
    color: 'from-navy to-brand-600',
  },
  {
    title: 'GoMove Logistics',
    category: 'Mobile App',
    tags: ['React Native', 'Maps', 'Realtime'],
    description: 'Driver + customer apps with live tracking and instant booking.',
  ...
  },
  {
    ...
    description: 'Brand website with CMS-powered portfolio and quote request flow.',
    color: 'from-brand-700 to-brand-400',
  },
  {
    title: 'ChatAssist Bot',
    category: 'Automation',
    tags: ['WhatsApp', 'OpenAI', 'Webhooks'],
    description: 'AI-powered support bot automating 70% of customer queries.',
    color: 'from-accent-cyan to-brand-600',
  },
  {
    title: 'LaunchWave',
    category: 'Landing Page',
    tags: ['Vite', 'React', 'Framer-ish'],
    description: 'High-converting product launch page with A/B tested hero.',
